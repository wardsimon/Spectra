...
%    [filename, pathname] = uigetfiles(filterspec, title, x, y)
...
%
% See also: uigetfile, getfiles, geturl
%
% Part of: iFiles utilities (ILL library)
% Author:  E. Farhi <farhi@ill.fr>. July 22nd, 2003.

% calls:   inline private functions

% history: Sep 09, 2003: corrected returned filename bug (get UD after uiwait)
